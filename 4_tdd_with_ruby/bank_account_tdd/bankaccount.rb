...
class BankAccount
  ...
  def acctChkBal
    return "The balance of your checking account is: #{@balance_check}."
  end
  ...
  def totalBal
    return "Your total balance is: #{@balance_check + @balance_savings}."
  end
  ...
  def withdrawChk(amount)
    ...
    if amount < @balance_check
      ...
      return "Your checking balance is now: #{@balance_check}."
    else
      raise "Your checking balance is too low."
    end
  end
  ...
  def withdrawSav(amount)
    ...
    if amount < @balance_savings
      ...
      raise "Your savings balance is too low."
    end
  end
